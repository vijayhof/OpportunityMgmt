...
- (void) setupParse
{
    ...
    // Setup parse
    //
    [Parse setApplicationId:@"UHDWeiQa4V7RVagroXp6NJ6UdoMiHn25Jdve0KVv" clientKey:@"UuJZ7TIipvBs9AkO6IhMvaOh19DGvCGEc7EJEKPq"];
...
- (void)initializeAppViewState
{
    ...
    [self.window makeKeyAndVisible]; // TODO - is this required?
}
...
- (void)setupRootViewController
{
    ...
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"MainiPhoneStoryboard" bundle:nil];
    //    UIViewController *vc = [storyboard instantiateViewControllerWithIdentifier:@"RootNavViewController"];
    UIViewController *vc = [storyboard instantiateViewControllerWithIdentifier:@"ContainerVCID"];
